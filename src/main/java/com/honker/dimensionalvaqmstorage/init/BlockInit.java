...
import com.honker.dimensionalvaqmstorage.block.VaqmTubeBlock;
...
public final class BlockInit {
    ...
    public static final RegistryObject<VaqmTubeBlock> VAQM_TUBE;

    static {
        VAQM_ORE = BLOCKS.register("vaqm_ore", VaqmOre::new);
        VAQM_TUBE = BLOCKS.register("vaqm_tube", VaqmTubeBlock::new);
    }
